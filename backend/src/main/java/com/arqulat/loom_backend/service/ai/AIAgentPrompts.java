 ...
 *
 * Passes 1+2 use natural language chain-of-thought with <RESULT> tag
 * extraction.
...
public class AIAgentPrompts {
         ...
         */
        public static final String SEMANTIC_PROMPT = "You are an expert diagram architect. Your job is to deeply analyze the user's request "
                        +
         ...
         */
        public static final String LAYOUT_PROMPT = "You are an expert diagram layout designer. Given the semantic analysis below, "
                        +
         ...
         */
        public static final String EXECUTE_PROMPT = "You are executing a diagram construction step-by-step.\n\n" +
                        "CONTEXT:\n" +
        ...
        /**
         * The old single-shot prompt — kept for backward compatibility but no longer
         * primary.
         */
